...
/**
 * Kafka Streams Topology builder for processing MAP messages from ODE MAP JSON -> MAP GeoJSON
 */
public class MapTopology {
    ...
    public static Topology build(String mapOdeJsonTopic, String processedMapTopic, String processedMapWTKTopic,
        ...
        KStream<Void, Bytes> rawOdeMapStream = builder.stream(mapOdeJsonTopic, Consumed.with(Serdes.Void(), // Key
                                                                                                            // serializer:
                                                                                                            // Raw has
                                                                                                            // no key,
                                                                                                            // so use
        ...
        KStream<Void, DeserializedRawMap> validatedOdeMapStream = rawOdeMapStream.mapValues((Void key, Bytes value) -> {
            ...
            try {
                ...
                deserializedRawMap.setOdeMapMessageFrameData(
                        JsonSerdes.OdeMessageFrame().deserializer().deserialize(mapOdeJsonTopic, value.get()));
